...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	vertices[0].position = D3DXVECTOR3(0.0f, 0.0f, 0.0f);  // Top left.
	vertices[0].color = D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f);

	vertices[1].position = D3DXVECTOR3(0.0f, 1.0f, 0.0f);  // Bottom left.
	...
	// Load the vertex array with data.
	vertices[3].position = D3DXVECTOR3(0.0f, 1.0f, 0.0f);  // Top left.
	...
	vertices[5].position = D3DXVECTOR3(1.0f, 0.0f, 0.0f);  // Bottom right.
